                    ...
                    <TableRow key={blog._id}>
                      ...
                      <TableCell className="px-5 py-4 sm:px-6 text-center">
                        <div className="flex flex-col items-center justify-center">
                          <span className="block font-medium text-gray-800 text-theme-sm dark:text-white/90 truncate max-w-xs">
                            {blog.title}
                          </span>
                      ...
                      <TableCell className="px-4 py-3 text-gray-500 text-center text-theme-sm dark:text-gray-400">
                        <code className="px-2 py-1 bg-gray-100 dark:bg-gray-800 rounded text-xs inline-block">
                          {blog.slug}
                        </code>
                      </TableCell>
      ...
      >
        <div className="p-6 sm:p-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Are you sure you want to delete <span className="font-semibold">"{selectedBlogTitle}"</span>? This action cannot be undone.
          </p>
