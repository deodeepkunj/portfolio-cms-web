    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const res = await fetch("/api/profile", {
                ...
                body: JSON.stringify({section: "header", data}),
            });

            if (!res.ok) {
                console.error("Failed to update header", await res.json());
            } else {
                closeModal();
            }
        } catch (err) {
                ...
                <div
                    ...
                    <div className="px-2 pr-14">
                        <h4 className="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">Edit Personal
                            Information</h4>
                        <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">Update your details to keep
                    ...
                    <form className="flex flex-col" onSubmit={(e) => {
                        ...
                        <div className="custom-scrollbar h-[450px] overflow-y-auto px-2 pb-3">
                            <h5 className="mb-5 text-lg font-medium text-gray-800 dark:text-white/90">Social Links</h5>
                            <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                                ...
                                <div>
                                    <Label>X.com</Label>
                                    <Input type="text" value={xLink} onChange={(e: any) => setXLink(e.target.value)}/>
                                </div>
                                <div>
                            ...
                            <div className="mt-7">
                                <h5 className="mb-5 text-lg font-medium text-gray-800 dark:text-white/90">Personal
                                    Information</h5>
                                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
