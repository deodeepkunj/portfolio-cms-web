...
export default function TopPagesTable({ data, days }: Props) {
      ...
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
            Most viewed pages in the last {days === "all" ? 365 : days} days
          </p>
        </div>
      </div>
        ...
        <Table>
          <TableHeader className="border-y border-gray-100 dark:border-gray-800">
            <TableRow>
              ...
              <TableCell isHeader className="py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">Users</TableCell>
                ...
                <TableRow key={`${page.path}-${index}`}>
                  <TableCell className="py-3">
                    <div>
                      ...
                      <span className="text-gray-500 text-theme-xs dark:text-gray-400">{page.path}</span>
                    </div>
                  </TableCell>
