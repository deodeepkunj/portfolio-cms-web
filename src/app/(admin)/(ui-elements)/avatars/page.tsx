...
export const metadata: Metadata = {
  title: "Next.js Avatars | Porfolio Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for Porfolio Admin - Next.js Tailwind CSS Admin Dashboard Template",
};
