...
export const metadata: Metadata = {
  title: "Next.js Badge | Porfolio Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Badge page for Porfolio Admin - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
