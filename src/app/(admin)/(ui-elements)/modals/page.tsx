...
export const metadata: Metadata = {
  title: "Next.js Modals | Porfolio Admin - Next.js Dashboard Template",
  description:
    "This is Next.js Modals page for Porfolio Admin - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
